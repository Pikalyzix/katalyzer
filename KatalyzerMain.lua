-- kat --
local Library = loadstring(game:HttpGet(("https://raw.githubusercontent.com/Pikalyzix/falsewoods/master/EditedZyrexLib.lua"),true))()
local CombatWindow = Library:CreateWindow("falsewoods | Combat")
--COMBAT--
CombatWindow:Label("-=Silent Aim=-")
CombatWindow:Button("Head Silent Aim", function()
...
ESP.MouseButton1Click:Connect(function()
    local OwlESP = loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/Pikalyzix/katalyzer/main/OwlESP.lua"))();
